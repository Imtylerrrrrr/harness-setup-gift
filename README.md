...
> ### 📖 가이드 본문 바로 읽기 → [imtylerrrrrr.github.io/harness-setup-gift](https://imtylerrrrrr.github.io/harness-setup-gift/)

AI 코딩 에이전트(Claude Code, Codex 등)를 **세팅 없이 날것으로** 쓰고 있다면, 이 저장소가 선물입니다.
아직 채팅(claude.ai 등)으로만 AI를 써봤어도 괜찮습니다 — 가이드가 그 차이부터 시작합니다.
